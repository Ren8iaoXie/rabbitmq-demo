...
public class SimpleJobTest {
    ...
    public static void main(String[] args) {
        ...
        CoordinatorRegistryCenter regCenter = new ZookeeperRegistryCenter(
                new ZookeeperConfiguration("127.0.0.1:2181", "ejob-standalone")
        );
        regCenter.init();
        ...
        dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/study?useUnicode=true&characterEncoding=utf-8");
