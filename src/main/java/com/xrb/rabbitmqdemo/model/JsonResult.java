...
public class JsonResult implements Serializable {
    ...
    //返回分页的空列表
    public static JsonResult returnNullList(){
        return returnNullList("获取列表信息成功");
    }
    //返回分页的空列表
    public static JsonResult returnNullList(String msg){
        Map<String,Object> resMap=new HashMap<>();
        resMap.put("list",new ArrayList<>());
        resMap.put("totalCount",0);
        return JsonResult.build(200,msg,resMap);
    }
//    public Boolean isOK() {
